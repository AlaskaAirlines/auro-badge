...
In cases where the project is not able to process JS assets, there are pre-processed assets available for use. See -- `auro-badge__bundled.js` for modern browsers. Legacy browsers such as IE11 are no longer supported.
...
<script src="https://cdn.jsdelivr.net/npm/@aurodesignsystem/auro-badge@3.0.0-beta.1/dist/auro-badge__bundled.js" type="module"></script>
```

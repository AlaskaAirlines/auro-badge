...
class AuroBadge extends i$2 {
  constructor() {
     ...
     * @private
     */
    this.buttonTag = versioning.generateTag('auro-button', buttonVersion, T);
  ...
  render() {
    return u$2`
      ${this.target
        ...
        : u$2`<div class="${this.label ? 'body-xs' : ''}">
          <slot @slotchange="${this.handleContentSlotChanges}"></slot>
        </div>`
      }
    `;

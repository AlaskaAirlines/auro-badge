...
class AuroButton extends AuroElement$1 {
   ...
   */
  get _renderTag() {
    if (this.static) return i$1`span`;

    return this.buttonHref ? i$1`a` : i$1`button`;
  }
  ...
  render() {
    return u`
      ${this.target
        ...
        : u`<div class="${this.label ? 'body-xs' : ''}">
          <slot @slotchange="${this.handleContentSlotChanges}"></slot>
        </div>`
      }
    `;
